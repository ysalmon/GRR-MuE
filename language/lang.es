...
$vocab['adapter fichiers langue'] = "Adaptar los ficheros de idioma";
$vocab['adapter fichiers langue explain'] = "GRR usa ficheros de idioma para la presentación. Tiene usted la posibilidad de substituir sus propios textos a los textos oficiales. Consultar la ayuda para saber más.";
$vocab['add'] = "Añadir";
...
$vocab['admin_type.php'] = "Tipos de reserva ";
    $vocab['admin_type_area.php'] = "Types de réservation établissement";
...
$vocab['affiche_dans_les mails'] = "Presentar el contenido en los mails automáticos (en caso de que esta función está activada)";
$vocab['affiche_dans_les vues'] = "Presentar el contenido en               jornadas, semana y mes";
...
$vocab['brief_description'] = "la descripción breve.";
    $vocab['plage_start'] = "L\'heure de debut de réservation‎ est incorrecte, elle doit commencer dans la plage.";
    $vocab['plage_end'] = "L\'heure de fin de réservation‎ est incorrecte, elle doit finir dans la plage.";
...
$vocab['days'] = "día(s)";
$vocab['debut_Jours/Cycles'] = "Número del día iniciando el primer ciclo de días";
...
$vocab['display_add_type_general'] = "Ajouter un type de réservation général";
$vocab['display_add_type_etablissement'] = "Ajouter un type de réservation à l'établissement";
...
$vocab['Explications des parametres configuration envoi automatique mails'] = "GRR usa PHPMailer para el envío de correos electrónicos. Con PHPMailer, hay dos métodos para enviar mails:<br />1) El método \"smtp\" permitiendo de conectarse a un servidor de mail lejano;<br />2) El método \"mail\" cuando el servidor de mail es local.<br />El método \"smtp\" puede también ser utilizado con un servidor local pero es preferible privilegiar la méthode \"mail\" con un servidor local porque es más rápida..";
$vocab['Explications methode smtp 1'] = "Si el método \"smtp\" es elegido, indicar el servidor SMTP";
$vocab['Explications methode smtp 2'] = "Si el método \"smtp\" es elegido y que ele servidor necesita una autentificación, indicar el nombre de usuario y la contraseña.";
$vocab['Explications suppression_automatique_des_reservations'] = "La activación de algunas funcionalidades de GRR necesita la posibilidad de establecer la execución automática de tareas.<br />Por ejemplo la supresión automática de ciertas reservas en el caso de las \"reservas sin garantía\", o también el envío de una notificación de retraso en caso de no restitución de un recurso.<br />Para efectuar estas tareas automáticas de supresión, hay dos configuraciones posibles, cada una teniendo sus inconvenientes y sus ventajas. Consulte la ayuda para más detalles.";
$vocab['explications_active_type'] = "<b>Observación: </b>cuando un tipo ya no está punteado, este ya no se propone al usuario efectuando o modificando una reserva, pero las reservas ya efectuadas siguen apareciendo en las planifaciones con este tipo, a pesar de estar desactivado.";
...
$vocab['info-bulle0'] = "No hay info-burbujas";
$vocab['info-bulle1'] = "Visualisación de los apellidos y nombres del beneficiario de la reserva";
$vocab['info-bulle2'] = "Visualisación de la descripción completa de la reserva";
...
$vocab['Liste des champs'] = "Lista de elecciones posibles separadas por el carácter |<br />y la elección por defecto precedida por el carácter &<br />(ejemplo: elección 1|&elección 2|elección 3)";
...
$vocab['message perso explain'] = "El mensaje más abajo se exhibe justo debajo del banner superior.";
...
$vocab['methode mail'] = "Utilizar el método \"mail\" (servidor mail local)";
$vocab['methode smtp'] = "Utilizar el método \"smtp\" (servidor mail distante)";
...
$vocab['nombre_jours_Jours/Cycles'] = "Número de días en un ciclo";
...
$vocab['Parametres configuration envoi automatique mails'] = "Parámetros de configuración del envío automático de mails";
...
$vocab['qui peut reserver pour autre utilisateur'] = "Excepto los administradores, precise al lado qué tipos de usuarios tienen derecho de hacer reservas en nombre de otros usuarios.";
...
$vocab['reservation au nom de'] = "Reserva al nombre de";
...
$vocab['Restauration de la base GRR'] = "Restauración de la base GRR";
$vocab['Restaurer la sauvegarde'] = "Restaurar la copia de seguridad. ";
...
$vocab['titre_config_Jours/Cycles'] = "Configuración de los \"días ciclos\"";
$vocab['too_may_entrys'] = "Las opciones elegidas crearán demasiadas reservacs.<br />¡Elija opciones diferentes!";
$vocab['total'] = "Total";
$vocab['tous les utilisateurs'] = "todos los usuarios";
...
$vocab['utilisateur smtp'] = "Usuario SMTP";
...
// Ajouts GIP RECIA :
$vocab['grr_ent_url'] = "Adresse du canal grr dans l'ENT (/portail/p/NOM_CANAL)";
?>
