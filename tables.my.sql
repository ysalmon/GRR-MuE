...
CREATE TABLE grr_log (LOGIN varchar(40) NOT NULL default '', START datetime NOT NULL default '2016-01-01 00:00:00', SESSION_ID varchar(64) NOT NULL default '', REMOTE_ADDR varchar(16) NOT NULL default '', USER_AGENT varchar(255) NOT NULL default '', REFERER varchar(255) NOT NULL default '', AUTOCLOSE enum('0','1') NOT NULL default '0', END datetime NOT NULL default '2016-01-01 00:00:00', PRIMARY KEY  (SESSION_ID,`START`));
...
INSERT INTO grr_utilisateurs VALUES ('ADMINISTRATEUR', 'Administrateur', 'grr', 'ab4f63f9ac65152575886860dde480a1', 'admin@labas.fr', 'administrateur', 'actif', 0, 0, 0, 0, 'default', 'item', 'fr','local');
...
INSERT INTO grr_setting VALUES ('begin_bookings', '1441058400');
...
INSERT INTO grr_setting VALUES ('version', '3.1.0');
INSERT INTO grr_setting VALUES ('versionRC', '0');
...
INSERT INTO grr_setting VALUES ('default_etablissement', '-1');
INSERT INTO grr_setting VALUES ('etablissement_open', '0');
